            ...
            <form action="{{ route('marcas-update', ['id' => $marca->id ]) }}" method="POST">
                ...
                @method('PUT') <!--forçando método 'PUT'-->
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $marca->nome }}" type="text" id="nome" name="nome" required class="form-control" placeholder="Informe um nome para a marca...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $marca->ano_fundacao }}" type="number" id="ano_fundacao" required name="ano_fundacao" class="form-control" placeholder="Informe um ano para a marca...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $marca->pais }}" type="text" id="pais" name="pais" required class="form-control" step="1" placeholder="Informe um país para a marca...">
                    </div>
